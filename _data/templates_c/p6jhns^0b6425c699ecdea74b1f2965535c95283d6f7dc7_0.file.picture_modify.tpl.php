...
/* Smarty version 3.1.29, created on 2017-02-13 11:17:32
  from "/var/www/html/admin/themes/default/template/picture_modify.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_58a1dc1c1aa994_71720859',
  'file_dependency' => 
  array (
    '0b6425c699ecdea74b1f2965535c95283d6f7dc7' => 
    array (
      0 => '/var/www/html/admin/themes/default/template/picture_modify.tpl',
      1 => 1486478392,
      2 => 'file',
    ),
  ),
...
function content_58a1dc1c1aa994_71720859 ($_smarty_tpl) {
...
<?php }?>
  ...
  <fieldset>
    ...
    <p>
      ...
      <br>
      <input type="text" class="large" name="name" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['NAME']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
">
    </p>
...
">
    ...
    <p>
      ...
      <br>
      <select data-selectize="categories" data-value="<?php echo htmlspecialchars(json_encode($_smarty_tpl->tpl_vars['associated_albums']->value), ENT_QUOTES, 'ISO-8859-1', true);?>
"
...
" name="associate[]" multiple style="width:600px;"></select>
    ...
    <p>
      ...
      <br>
      <select data-selectize="categories" data-value="<?php echo htmlspecialchars(json_encode($_smarty_tpl->tpl_vars['represented_albums']->value), ENT_QUOTES, 'ISO-8859-1', true);?>
"
        placeholder="<?php echo l10n('Type in a search term');?>
"
    ...
    <p>
      ...
      <br>
      <select data-selectize="tags" data-value="<?php echo htmlspecialchars(json_encode($_smarty_tpl->tpl_vars['tag_selection']->value), ENT_QUOTES, 'ISO-8859-1', true);?>
"
        placeholder="<?php echo l10n('Type in a search term');?>
"

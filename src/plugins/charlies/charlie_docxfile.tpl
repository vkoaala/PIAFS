...
<embed src="{$SRC_IMG}" type="application/vnd.openxmlformats-officedocument.wordprocessingml.document" toolbar="false" scrollbar="true" pagemode="none" transparent="true" width="98%" height=750px >
<NOEMBED> Your browser does not support embedded docx files. </NOEMBED>
</embed></object>
</div>
{html_head}

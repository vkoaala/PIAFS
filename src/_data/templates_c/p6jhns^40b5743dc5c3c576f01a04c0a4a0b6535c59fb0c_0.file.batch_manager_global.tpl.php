...
/* Smarty version 3.1.29, created on 2017-02-10 09:05:58
  from "/var/www/html/PIAFS/src/admin/themes/default/template/batch_manager_global.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_589dc8c67eb1b0_29541958',
  'file_dependency' => 
  array (
    '40b5743dc5c3c576f01a04c0a4a0b6535c59fb0c' => 
    array (
      0 => '/var/www/html/PIAFS/src/admin/themes/default/template/batch_manager_global.tpl',
      1 => 1486493138,
      2 => 'file',
    ),
  ),
...
function content_589dc8c67eb1b0_29541958 ($_smarty_tpl) {
if (!is_callable('smarty_function_html_options')) require_once '/var/www/html/PIAFS/src/include/smarty/libs/plugins/function.html_options.php';
...
<?php $_smarty_tpl->smarty->ext->_subtemplate->render($_smarty_tpl, "file:include/colorbox.inc.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('load_mode'=>'async'), 0, false);
?>
...
?>
        ...
        <a id="delete_orphans" href="admin.php?page=batch_manager&amp;action=delete_orphans&amp;pwg_token=<?php echo $_smarty_tpl->tpl_vars['PWG_TOKEN']->value;?>
" style="<?php if (!isset($_smarty_tpl->tpl_vars['filter']->value['prefilter']) || $_smarty_tpl->tpl_vars['filter']->value['prefilter'] != 'no_album') {?>display:none<?php }?>"><?php echo l10n('Delete %d orphan photos',$_smarty_tpl->tpl_vars['NB_ORPHANS']->value);?>
</a>
      ...
      <li id="filter_category" <?php if (!isset($_smarty_tpl->tpl_vars['filter']->value['category'])) {?>style="display:none"<?php }?>>
        ...
        <select data-selectize="categories" data-value="<?php echo htmlspecialchars(json_encode($_smarty_tpl->tpl_vars['filter_category_selected']->value), ENT_QUOTES, 'ISO-8859-1', true);?>
"
      ...
      <li id="filter_tags" <?php if (!isset($_smarty_tpl->tpl_vars['filter']->value['tags'])) {?>style="display:none"<?php }?>>
        ...
        <select data-selectize="tags" data-value="<?php echo htmlspecialchars(json_encode($_smarty_tpl->tpl_vars['filter_tags']->value), ENT_QUOTES, 'ISO-8859-1', true);?>
"
...
">
    ...
    <p class="actionButtons">
      ...
      <a id="removeFilters"><?php echo l10n('Remove all filters');?>
</a>
    </p>
...
" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['thumbnail']->value['TITLE'], ENT_QUOTES, 'ISO-8859-1', true);?>

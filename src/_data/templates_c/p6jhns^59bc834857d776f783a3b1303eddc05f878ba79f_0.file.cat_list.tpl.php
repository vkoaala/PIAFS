<?php
/* Smarty version 3.1.29, created on 2017-02-10 09:05:50
  from "/var/www/html/PIAFS/src/admin/themes/default/template/cat_list.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_589dc8be59de19_30853455',
  'file_dependency' => 
  array (
    '59bc834857d776f783a3b1303eddc05f878ba79f' => 
    array (
      0 => '/var/www/html/PIAFS/src/admin/themes/default/template/cat_list.tpl',
      1 => 1486493138,
      2 => 'file',
    ),
  ),
...
function content_589dc8be59de19_30853455 ($_smarty_tpl) {
...
<p class="showCreateAlbum" id="notManualOrder">
  <a href="#" id="addAlbumOpen" class="icon-plus-circled"><?php echo l10n('create a new album');?>
</a>
  <?php if (count($_smarty_tpl->tpl_vars['categories']->value)) {?><span class="userSeparator">&middot;</span><a href="#" id="autoOrderOpen" class="icon-sort-number-up"><?php echo l10n('apply automatic sort order');?>
</a><?php }?>
...
"><span class="icon-pencil"></span><?php echo l10n('Edit');?>
        ...
        <span class="userSeparator">&middot;</span><a href="<?php echo $_smarty_tpl->tpl_vars['category']->value['U_CHILDREN'];?>
"><span class="icon-sitemap"></span><?php echo l10n('manage sub-albums');?>
</a>
<?php if (isset($_smarty_tpl->tpl_vars['category']->value['U_SYNC'])) {?>
        <span class="userSeparator">&middot;</span><a href="<?php echo $_smarty_tpl->tpl_vars['category']->value['U_SYNC'];?>
"><span class="icon-exchange"></span><?php echo l10n('Synchronize');?>
</a>
<?php }
if (isset($_smarty_tpl->tpl_vars['category']->value['U_DELETE'])) {?>
        <span class="userSeparator">&middot;</span><a href="<?php echo $_smarty_tpl->tpl_vars['category']->value['U_DELETE'];?>
...
if (cat_admin_access($_smarty_tpl->tpl_vars['category']->value['ID'])) {?>
        <span class="userSeparator">&middot;</span><a href="<?php echo $_smarty_tpl->tpl_vars['category']->value['U_JUMPTO'];?>
